    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          desc="We begin by understanding the problem, researching user needs, and defining clear goals."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          desc="We translate insights into creative solutions, crafting intuitive and engaging experiences."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          desc="We refine, build, and deploy with precision — ensuring quality, performance, and impact."
        >
          <CanvasRevealEffect
            animationSpeed={3}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4  lg:h-[35rem] h-[20rem] rounded-3xl "
    >
